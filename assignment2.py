...
print(f"x_sym^3 coefficient is {get_coefficient(4)}")
...
print(f"2nd derivative of x_sym ** 3 * sin(x_sym ** 2 + 1) at 0.1 = {nth_derivative(2, 0.1):.4f}")

# Q5
print(f"{' Q5 ':-^75}")
# f = fps(cos(x_sym ** 2 + sqrt(x_sym)))
